...
\begin{proof}
    ...
    \begin{enumerate}
        \item If $X\subseteq E$ is arbitrary and we pick any element $x \in X$ then $X \cup x = X$. Consequently $r(X \cup x)= r(X)$ thus $x \in \cl(X)$ by defintion of the closure operator which shows the inclusion $X \subseteq \cl(X)$.
