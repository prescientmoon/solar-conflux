...
\begin{proof}
	...
	\begin{enumerate}
		...
		\item Assume the statemenet is true for some $|A - B| = p$. We will attempt to prove it for $|A - B| = p + 1$. Let $k = |A \cap B| = |A| - p$. Let $a _1 \ldots a _n$ be the elements of $A$ such that $a _1 \ldots a_k$ are all the members of $A \cap B$ for some $k$. Let $ a _1 \ldots a_k, b _{k + 1} \ldots b _m$ be the elements of $B$. It remains to prove that $m \geq n$.
