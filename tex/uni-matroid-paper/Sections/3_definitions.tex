...
In figure~\ref{fig:1234-matroid-bases}, we find a depiction of the matroid we've seen in section 2.1. In addition, we also highlight the bases of the matroid in red. Two properties can be observed:
\begin{enumerate}
