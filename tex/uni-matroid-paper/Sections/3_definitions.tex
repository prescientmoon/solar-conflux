...
\end{theorem}
\begin{proof} 
    This proof was inspired by \cite[p. 24]{oxley1}. We will prove that the statement holds with $Y-X = \{a_1,a_2,\dots,a_k\}$ for all integers $k$.
    \begin{enumerate}
...
This proof was ins To prove that $(E,\mathcal{I})$ is a matroid, we will prove that $\mathcal{I}$ satisfies (I1)-(I3).
    \begin{enumerate}
