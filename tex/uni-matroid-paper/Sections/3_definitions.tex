...
\begin{defn}
    ...
    \begin{enumerate}
        ...
        \item If $\mathcal{C_1}$ and $\mathcal{C_2}$ are members of $C$ and $C_1 \subseteq C_2$, then $C_1 = C_2.$

        \item If $\mathcal{C_1}$ and $\mathcal{C_2}$ are distinct members of C and there exist an $e \in C_1 \cap C_2$, then there is a member $C_3$ of $C$, such that $C_3 \subseteq (C_1  \cup C_2) - e$
    \end{enumerate}
