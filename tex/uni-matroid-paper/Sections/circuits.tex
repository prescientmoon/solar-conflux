x\subsection{Circuits}\label{sec:circuits}
...
Again, we will use the same matroid example as before, this time adding circuits to the drawing (in blue). The circuits are minimal dependent sets where everything above them is a dependent set. Also note how all independent sets do not contain any circuit.
