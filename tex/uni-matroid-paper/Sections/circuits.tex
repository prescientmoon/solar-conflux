          ...
          \begin{enumerate}
            ...
            \begin{enumerate}
              ...
              \item $(Y \cup x) - y$ is independent. 
                ...
                \begin{proof}
                If this is not the case, there must exist some $D \in \mathcal C$ with $D \subseteq (Y \cup x) - y$. This also implies that $D$ is a circuit with $D \subseteq Y \cup x$. By the uniqueness $C$ proved before we now have $D = C$. But this would imply that $y\in C = D$ so $y \in (Y \cup x) - y$ which is a contradiction.  
                \end{proof}
