...
\begin{proof}
    ...
    \begin{figure}[h]
        ...
        \caption{Standart representative form of the dual of a matroid as established in Theorem \ref{DualRepMat}}
