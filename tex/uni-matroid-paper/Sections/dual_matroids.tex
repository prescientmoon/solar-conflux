...
We have the depiction from previous sections (Figure \ref{fig:1234-matroid-circuits}), but now we also add the one that correspond to the dual (See Figure \ref{DoubleDiagramDual}). To the \textbf{left} we have the depiction corresponding to the \textbf{original matroid}, and to the \textbf{right} we have the one corresponding to its \textbf{dual matroid}. 
