...
\end{theorem}
The proof for this theorem involves concepts outside of what was introdcued in this article. So it will not be given here. If you are interested in the proof it can be found in \cite{oxley1} (Section 2.3).
