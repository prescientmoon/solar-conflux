...
\begin{figure}[H]
	...
	\caption{Diagram showing two double tori. The red dotted path on the top double torus is a contractible loop, while the red path on the bottom one is not contractible. \cite{Herlihy_1996}}
	\label{fig:CoLoop}
\end{figure}
